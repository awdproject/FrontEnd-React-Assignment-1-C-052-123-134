      ...
      <section className="relative py-20 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Get in touch to make a reservation or inquire about our services
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-500 text-white py-4 rounded-lg font-semibold text-lg hover:bg-amber-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
                  Submit Reservation
                </button>
              </form>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@resto.com<br />reservations@resto.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-800">5:00 PM - 10:00 PM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Friday - Saturday</span>
                    <span className="font-semibold text-gray-800">5:00 PM - 11:00 PM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Sunday</span>
                    <span className="font-semibold text-gray-800">5:00 PM - 9:00 PM</span>
                  </div>
                </div>
              </div>
